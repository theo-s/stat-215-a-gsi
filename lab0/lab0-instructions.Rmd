...
title: "Lab 0"
author: |
  | Theo Saarinen (based on materials by Omer Ronen, James Duncan, Tiffany Tang, Zoe Vernon, Rebecca Barter, Yuval
...
1. If you have already set up your Github account, clone my stat-215-a-gsi repo by typing in the terminal (`git clone https://github.com/theo-s/stat-215-a-gsi`) to get the class materials and data for this lab. These will live in the `lab0/` folder. If you have already cloned this repo, you can instead just pull any changes from the stat-215-a-gsi github repo (`git pull`).
...
```
on the scf cluster (Error will be printed if found).

### R packages

If you wish to use any new R packages (this is anything that requires `install.packages`) please ask for approval [here](https://docs.google.com/spreadsheets/d/1lyP3xHMZEGc9CFtqimRlsaiXc6RODkHj54WiD4BuLdY/edit?usp=sharing).
